          ...
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center gap-2.5 mb-5 group">
              ...
              <div className="leading-none">
                <div className="font-bold text-white text-sm tracking-tight">Le Software</div>
                <div className="font-bold text-cyan-400 text-sm tracking-tight -mt-px">Solutions</div>
              </div>
            </Link>
