        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-2xl p-8">
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-6">
              ...
              <div>
                <h2 className="text-lg font-extrabold text-gray-900">Verified Business Details</h2>
                <p className="text-gray-500 text-sm">Le Software Solutions — Registered Sole Trader, United Kingdom</p>
              </div>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 bg-white rounded-lg border border-blue-100 flex items-center justify-center shrink-0">
                ...
                <div>
                  <p className="text-xs text-gray-400 font-medium uppercase tracking-wide mb-0.5">Business Address</p>
                  <p className="text-sm text-gray-800 font-medium leading-snug">Flat 3, 1 Stockleight Road,<br />St Leonards on Sea,<br />East Sussex, TN37 6DJ, UK</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 bg-white rounded-lg border border-blue-100 flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <a href="mailto:info@lesoftwaresolutions.com" className="text-sm text-blue-600 hover:underline font-medium break-all">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+447393454245" className="text-sm text-blue-600 hover:underline font-medium">
                    +44 7393 454245
                  </a>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-400 font-medium uppercase tracking-wide mb-0.5">Business Type</p>
                  <p className="text-sm text-gray-800 font-medium">Registered Sole Trader<br />United Kingdom</p>
                </div>
              </div>
            </div>
          </div>
